...
function exportCSV() {
	...
	for (var i=0; i<features.length; i++) {
		fileContent=fileContent +  '\r\n' + features[i].properties.OID + "," + features[i].properties.NM.replaceAll(",", " ") + "," + features[i].properties.FM.replaceAll(",", " ") + "," + features[i].properties.TO.replaceAll(",", " ") + "," + features[i].properties.FN + "," + features[i].properties.PCI + "," + features[i].properties.YR;
	}
