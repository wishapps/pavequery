...
function applyFilter() {
	...
	if (document.getElementById("chkLY").checked) {
		var lowLYear = 2005;
        var upLYear = 2020;
        ...
        if (isNaN(document.getElementById("toLYR").value) == false) {
            if (parseInt(document.getElementById("toLYR").value) > 2005 && parseInt(document.getElementById("toLYR").value)<2020) {
